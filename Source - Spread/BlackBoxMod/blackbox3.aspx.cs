...
public partial class blackbox3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!Request.FilePath.Contains("BlackboxHome"))
            {
                                                    ...
                                                    if (!isMor || !isEve)
                                                    {
                                                        ...
                                                        for (int scet = 0; scet <= sectionspilt.GetUpperBound(0); scet++)
                                                        {
                                                                                            ...
                                                                                            if (check_lab == "0" || check_lab.Trim().ToLower() == "false")
                                                                                            {
                                                                                                ...
                                                                                                if (dsstuatt.Tables.Count > 0 && dsstuatt.Tables[0].Rows.Count > 0)
                                                                                                {
                                                                                                    ...
                                                                                                    else
                                                                                                    {
                                                                                                        ...
                                                                                                        hours++;
                                                                                                        sno++;
                                                                                                        string subb_no = da.GetFunction("select subject_code from subject where subject_no='" + sp2[0] + "'");
                                                                                                        Boolean subjflag = false;
                                                                                                        if (sectionspilt.GetUpperBound(0) > 0)
                                                                                                        {
                                                                                                            string bat = Dept_name.ToString();
                                                                                                            if (!hsdate.ContainsKey(date + "-Batch : " + batchyear + " " + '-' + " Branch : " + coursename + "-" + bat + " - Sem : " + sem + " " + '-' + " Section " + '-' + " " + chksectionvalue + " and subject_code: " + subb_no + ""))
                                                                                                            {
                                                                                                                subjflag = true;
                                                                                                                FpSpread1.Sheets[0].RowCount++;
                                                                                                                ...
                                                                                                                hsdate.Add(date + "-Batch : " + batchyear + " " + '-' + " Branch : " + coursename + "-" + bat + " - Sem : " + sem + " " + '-' + " Section " + '-' + " " + chksectionvalue + " and subject_code: " + subb_no + "", date);
                                                                                                                FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Text = "Batch : " + batchyear + " " + '-' + " Branch : " + coursename + "-" + bat + " - Sem : " + sem + " " + '-' + " Section " + '-' + " " + chksectionvalue + " and subject_code: " + subb_no + "";
                                                                                                                if (forschoolsetting == true)
                                                                                                                {
                                                                                                                    FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Text = "Year : " + batchyear + " " + '-' + " Standard : " + bat + " - Term : " + sem + " " + '-' + " Section " + '-' + " " + chksectionvalue + " and subject_code: " + subb_no + " ";
                                                                                                                }
                                                                                                        ...
                                                                                                        else
                                                                                                        {
                                                                                                            ...
                                                                                                            if (!hsdate.ContainsKey(date + "-Batch : " + batchyear + " " + '-' + " Branch : " + coursename + "-" + bat + " - Sem : " + sem + " " + '-' + " Section " + '-' + " " + chksectionvalue + " and subject_code: " + subb_no + ""))
                                                                                                            {
                                                                                                                ...
                                                                                                                //  string bat = Dept_name.ToString();
                                                                                                                hsdate.Add(date + "-Batch : " + batchyear + " " + '-' + " Branch : " + coursename + "-" + bat + " - Sem : " + sem + " " + '-' + " Section " + '-' + " " + chksectionvalue + " and subject_code: " + subb_no + "", date);
                                                                                                                FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Text = "Batch : " + batchyear + " " + '-' + " Branch : " + coursename + "-" + bat + " - Sem : " + sem + " and subject_code: " + subb_no + " ";
                                                                                                                if (forschoolsetting == true)
                                                                                                                {
                                                                                                                    FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Text = "Year : " + batchyear + " " + '-' + " Standard : " + bat + " - Term : " + sem + " and subject_code: " + subb_no + "  ";
                                                                                                                }
                                                                                                                FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Font.Bold = true;
                                                                                                                FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Font.Size = FontUnit.Large;
                                                                                                                FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Font.Name = "Book Antiqua";
                                                                                                        ...
                                                                                                        {
                                                                                                            FpSpread1.Sheets[0].RowCount++;
                                                                                                            FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Text = "Please Select Subjectchooser";
                                                                                                            FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Font.Bold = true;
                                                                                                            FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Font.Size = FontUnit.Large;
                                                                                                            FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Font.Name = "Book Antiqua";
                                                                                                            FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].HorizontalAlign = HorizontalAlign.Center;
                                                            ...
                                                            if (hours == 0)
                                                            {
                                                                ...
                                                                FpSpread1.Sheets[0].RowCount++;
                                                                FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Text = "Staff Completed the Attendance";
                                                                FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Font.Bold = true;
                                                                FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Font.Size = FontUnit.Large;
                                                                FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].Font.Name = "Book Antiqua";
                                                                FpSpread1.Sheets[0].Cells[FpSpread1.Sheets[0].RowCount - 1, 2].HorizontalAlign = HorizontalAlign.Center;
