        ...
        <div style="height: 183px">
            ...
            <table>
                <tr>
                    ...
                    <td class="style35">
                        <asp:CheckBox ID="chk_Time" runat="server" Text="In Between Time" Style="position: absolute;
                            margin-top: -11px; margin-left: 19px" />
                    </td>
                    <td class="style35">
                        <asp:ImageButton ID="btnsearch" runat="server" BorderWidth="1px" Height="33px" ImageUrl="~/bioimage/Search Button.jpg"
                            OnClick="btnsearch_Click" Width="91px" Style="margin-top: -11px; margin-left: 143px" />
                    </td>
                </tr>
            </table>
            ...
            <table>
                ...
                <tr>
                    <td class="style14">
                        ...
                        <asp:Label ID="lblHostelname" runat="server" Text="Hostel Name" Font-Bold="True"
                        ...
                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txthostelname" runat="server" CssClass="textbox  textbox1 txtheight3"
                                    ReadOnly="true">--Select--</asp:TextBox>
                                <asp:Panel ID="pnlhostelname" runat="server" BackColor="White" BorderColor="Black"
                        ...
                        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txtfloorname" runat="server" CssClass="textbox  textbox1 txtheight3"
                                    ReadOnly="true">--Select--</asp:TextBox>
                                <asp:Panel ID="pnlfloorName" runat="server" BackColor="White" BorderColor="Black"
                                    BorderStyle="Solid" BorderWidth="2px" CssClass="multxtpanel" Width="150px" Height="180px"
                                    Style="position: absolute;">
                ...
                <tr>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txtrollnum" runat="server" CssClass="textbox  textbox1 txtheight3"
                                    ReadOnly="true">--Select--</asp:TextBox>
                                <asp:Panel ID="pnlroll_num" runat="server" BackColor="White" BorderColor="Black"
                                    BorderStyle="Solid" BorderWidth="2px" CssClass="multxtpanel" Width="150px" Height="180px"
                                    Style="position: absolute;">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txtstudename" runat="server" CssClass="textbox  textbox1 txtheight3"
                                    ReadOnly="true">--Select--</asp:TextBox>
                                <asp:Panel ID="pnl_studeName" runat="server" BackColor="White" BorderColor="Black"
                                    BorderStyle="Solid" BorderWidth="2px" CssClass="multxtpanel" Width="150px" Height="180px"
                                    Style="position: absolute;">
                    ...
                    <td>
                        <asp:Label ID="lblorder" runat="server" Text="OrderBy" Font-Bold="True" Font-Names="Book Antiqua"
                        ...
                        <asp:DropDownList ID="ddlorder" runat="server" Font-Bold="true" Font-Size="Medium"
                            ...
                            <asp:ListItem Text="Floor"></asp:ListItem>
                            <asp:ListItem Text="Room"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBoxList ID="cblsearch" runat="server" AutoPostBack="true" Height="20px"
                                    ...
                                    <asp:ListItem Value="Finger ID">Finger ID</asp:ListItem>
                                </asp:CheckBoxList>
                            </td>
                        </tr>
                        <tr>
            ...
            <fieldset id="Fieldset1" runat="server" visible="false" style="width: 75px; font-family: Book Antiqua;
                font-weight: bold; height: 13px; background-color: Chocolate; margin-left: 900px;
                margin-top: -32px;">
