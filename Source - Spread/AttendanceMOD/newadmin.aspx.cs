...
public partial class newadmin : System.Web.UI.Page
{
    ...
    DataRow attendr = null;
    DataTable sliplistdt = new DataTable();
    DataRow sliplistdr = null;
    ArrayList row1 = new ArrayList();
    ArrayList row2 = new ArrayList();
    DataTable strcomodt = new DataTable();
    DataRow strcomodr = null;
    DataTable strcomo1dt = new DataTable();
    DataRow strcomo1dr = null;
    DataTable strcomo2dt = new DataTable();
    DataRow strcomo2dr = null;
    DataTable strcomo1adt = new DataTable();
    DataRow strcomo1adr = null;
    DataTable attendatadt = new DataTable();
    DataRow attendatadr = null;
    DataTable attendatatag = new DataTable();
    DataRow attendatatagdr = null;
    DataTable tagnotedt = new DataTable();
    DataRow tagnotedr = null;
    DataTable attndt = new DataTable();
    #endregion
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Session["attendt"] != null)
            {
                Session.Remove("attendt");
            }
        }
        callGridBind();
    }
    ...
    public void callGridBind()
    {
        if (Session["attendt"] != null)
        {
            DataTable gviewtab = (DataTable)Session["attendt"];
            gview.DataSource = gviewtab;
            gview.DataBind();
        }
        else
        {
    ...
    protected void Btngo_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ArrayList rowtag = new ArrayList();
            tagnotedt.Clear();
            ...
            if (staffcode == "" || staffcode == null)
            {
                ...
                if (txtFromDate.Text != "")
                {
                    if (TxtToDate.Text != "")
                    {
                        ...
                        attendt.Columns.Add("tagnote");
                        attendt.Columns.Add("S.No");
                        attendt.Columns.Add("Select");
                        attendt.Columns.Add("Roll No");
                        attendt.Columns.Add("Reg No");
                        attendt.Columns.Add("Student Name");
                        attendt.Columns.Add("Student Type");

                        tagnotedt.Columns.Add("tagnote");
                        tagnotedt.Columns.Add("S.No");
                        tagnotedt.Columns.Add("Select");
                        tagnotedt.Columns.Add("Roll No");
                        tagnotedt.Columns.Add("Reg No");
                        tagnotedt.Columns.Add("Student Name");
                        tagnotedt.Columns.Add("Student Type");
                        ...
                        rowtag.Add("Roll No");
                        rowtag.Add("Reg No");
                        rowtag.Add("Student Name");
                        rowtag.Add("Student Type");
                        ...
                        row1.Add("Roll No");
                        row1.Add("Reg No");
                        row1.Add("Student Name");
                        row1.Add("Student Type");
                        ...
                        row2.Add("Roll No");
                        row2.Add("Reg No");
                        row2.Add("Student Name");
                        row2.Add("Student Type");

                        attendr = attendt.NewRow();
                        attendt.Rows.Add(attendr);
                        attendr = attendt.NewRow();
                        attendt.Rows.Add(attendr);
                        attendr = attendt.NewRow();
                        attendt.Rows.Add(attendr);
                        ...
                        if (strquery.Trim() != "")
                        {
                            ...
                            {
                                strcomodt.Clear(); strcomo1dt.Clear(); strcomo1adt.Clear(); strcomo2dt.Clear();
                                strcomodt.Columns.Add("atten");
                                strcomo1dt.Columns.Add("atten");
                                strcomo1adt.Columns.Add("atten");
                                strcomo2dt.Columns.Add("atten");
                                ...
                                strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "Select for All"; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = " "; strcomo1adt.Rows.Add(strcomo1adr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = " "; strcomodt.Rows.Add(strcomodr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = " "; strcomo1dt.Rows.Add(strcomo1dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = " "; strcomo2dt.Rows.Add(strcomo2dr);
                                ...
                                for (int od_temp = 0; od_temp <= split_od_rights.GetUpperBound(0); od_temp++)
                                {
                                    ...
                                    strcomodr = strcomodt.NewRow(); strcomodr["atten"] = split_od_rights[od_temp].ToString(); strcomodt.Rows.Add(strcomodr);
                                    strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = split_od_rights[od_temp].ToString(); strcomo1dt.Rows.Add(strcomo1dr);
                                    strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = split_od_rights[od_temp].ToString(); strcomo1adt.Rows.Add(strcomo1adr);
                                    strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = split_od_rights[od_temp].ToString(); strcomo2dt.Rows.Add(strcomo2dr);
                                }
                            }
                            else
                            {
                                ...
                                strcomodr = strcomodt.NewRow(); strcomodr["atten"] = " "; strcomodt.Rows.Add(strcomodr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = "P"; strcomodt.Rows.Add(strcomodr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = "A"; strcomodt.Rows.Add(strcomodr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = "OD"; strcomodt.Rows.Add(strcomodr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = "SOD"; strcomodt.Rows.Add(strcomodr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = "ML"; strcomodt.Rows.Add(strcomodr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = "NSS"; strcomodt.Rows.Add(strcomodr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = "L"; strcomodt.Rows.Add(strcomodr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = "NCC"; strcomodt.Rows.Add(strcomodr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = "HS"; strcomodt.Rows.Add(strcomodr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = "PP"; strcomodt.Rows.Add(strcomodr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = "SYOD"; strcomodt.Rows.Add(strcomodr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = "COD"; strcomodt.Rows.Add(strcomodr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = "OOD"; strcomodt.Rows.Add(strcomodr); strcomodr = strcomodt.NewRow(); strcomodr["atten"] = "LA"; strcomodt.Rows.Add(strcomodr);

                                strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = " "; strcomo1dt.Rows.Add(strcomo1dr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = "P"; strcomo1dt.Rows.Add(strcomo1dr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = "A"; strcomo1dt.Rows.Add(strcomo1dr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = "OD"; strcomo1dt.Rows.Add(strcomo1dr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = "SOD"; strcomo1dt.Rows.Add(strcomo1dr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = "ML"; strcomo1dt.Rows.Add(strcomo1dr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = "NSS"; strcomo1dt.Rows.Add(strcomo1dr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = "L"; strcomo1dt.Rows.Add(strcomo1dr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = "NCC"; strcomo1dt.Rows.Add(strcomo1dr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = "HS"; strcomo1dt.Rows.Add(strcomo1dr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = "PP"; strcomo1dt.Rows.Add(strcomo1dr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = "SYOD"; strcomo1dt.Rows.Add(strcomo1dr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = "COD"; strcomo1dt.Rows.Add(strcomo1dr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = "OOD"; strcomo1dt.Rows.Add(strcomo1dr); strcomo1dr = strcomo1dt.NewRow(); strcomo1dr["atten"] = "LA"; strcomo1dt.Rows.Add(strcomo1dr);

                                strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = " "; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "P"; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "A"; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "OD"; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "SOD"; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "ML"; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "NSS"; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "L"; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "NCC"; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "HS"; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "PP"; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "SYOD"; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "COD"; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "OOD"; strcomo1adt.Rows.Add(strcomo1adr); strcomo1adr = strcomo1adt.NewRow(); strcomo1adr["atten"] = "LA"; strcomo1adt.Rows.Add(strcomo1adr);

                                strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = " "; strcomo2dt.Rows.Add(strcomo2dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = "P"; strcomo2dt.Rows.Add(strcomo2dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = "A"; strcomo2dt.Rows.Add(strcomo2dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = "OD"; strcomo2dt.Rows.Add(strcomo2dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = "SOD"; strcomo2dt.Rows.Add(strcomo2dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = "ML"; strcomo2dt.Rows.Add(strcomo2dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = "NSS"; strcomo2dt.Rows.Add(strcomo2dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = "L"; strcomo2dt.Rows.Add(strcomo2dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = "NCC"; strcomo2dt.Rows.Add(strcomo2dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = "HS"; strcomo2dt.Rows.Add(strcomo2dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = "PP"; strcomo2dt.Rows.Add(strcomo2dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = "SYOD"; strcomo2dt.Rows.Add(strcomo2dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = "COD"; strcomo2dt.Rows.Add(strcomo2dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = "OOD"; strcomo2dt.Rows.Add(strcomo2dr); strcomo2dr = strcomo2dt.NewRow(); strcomo2dr["atten"] = "LA"; strcomo2dt.Rows.Add(strcomo2dr);
                        ...
                        if (days >= 0)
                        {
                            ...
                            if (dsstudent.Tables.Count > 0 && dsstudent.Tables[0].Rows.Count > 0)
                            {
                                ...
                                {
                                    string tagnote = string.Empty;
                                    sno++;

                                    attendr = attendt.NewRow();

                                    attendr["S.No"] = sno;
                                    attendr["Roll No"] = dsstudent.Tables[0].Rows[stu]["Roll_no"].ToString();
                                    attendr["Reg No"] = dsstudent.Tables[0].Rows[stu]["reg_no"].ToString();
                                    attendr["Student Name"] = dsstudent.Tables[0].Rows[stu]["stud_name"].ToString();
                                    attendr["Student Type"] = dsstudent.Tables[0].Rows[stu]["stud_type"].ToString();
                                    tagnote = dsstudent.Tables[0].Rows[stu]["app_no"].ToString() + "$" + dsstudent.Tables[0].Rows[stu]["Adm_Date"].ToString();

                                    attendr["tagnote"] = tagnote;
                            ...
                            string qry = "Select * from tbl_consider_day_order where degree_code='" + ddlbranch.SelectedValue.ToString() + "' and batch_year='" + ddlbatch.SelectedValue.ToString() + "' and semester='" + ddlsem.SelectedValue.ToString() + "'";
                            DataSet dsqry = dacces2.select_method_wo_parameter(qry, "Text");
                            if (dsqry.Tables.Count > 0 && dsqry.Tables[0].Rows.Count > 0)
                            {
                                for (int dc = 0; dc < dsqry.Tables[0].Rows.Count; dc++)
                                {
                                    DateTime dtdcf = Convert.ToDateTime(dsqry.Tables[0].Rows[dc]["from_date"].ToString());
                                    DateTime dtdct = Convert.ToDateTime(dsqry.Tables[0].Rows[dc]["to_date"].ToString());
                                    string alternateDayOrder = Convert.ToString(dsqry.Tables[0].Rows[dc]["DayOrder"]).Trim();
                                    byte alternateDay = 0;
                        ...
                        HOLDAY:
                            ...
                            if (noofhours.ToString().Trim() != "" && noofhours != "0" && noofhours.ToString() != null)
                            {
                                    ...
                                    if (temp_date <= dt2)
                                    {
                                        ...
                                        if (no_hrs > 0)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                cur_day = Convert.ToDateTime(currdate);
                                                ...
                                                {
                                                    srt_day = findDayName(dicAlternateDayOrder[cur_day]);
                                        ...
                                        else
                                        {
                                            ...
                                            for (i = starthour; i <= Convert.ToInt32(noofhours.ToString()); i++)
                                            {
                                                ...
                                                dateformat = Convert.ToString(differdays[date_loop]);
                                                if (Convert.ToString(Day_Order).Trim() != "")
                                                {
                                                    row1.Add(dateformat.ToString() + " [Day Order " + Day_Order.ToString() + "]");
                                                }
                                                else
                                                {
                                                    row1.Add(dateformat.ToString());
                                                }

                                                System.Text.StringBuilder att1 = new System.Text.StringBuilder(dateformat.ToString());
                                                AddTableColumn(tagnotedt, att1);
                                                rowtag.Add(temp_date);

                                                row2.Add(Convert.ToString(i));

                                                System.Text.StringBuilder att = new System.Text.StringBuilder(Convert.ToString(i));
                                                AddTableColumn(attendt, att);

                                                AddTableColumn(attendatadt, att);

                                                AddTableColumn(attendatatag, att);
                                            }
                                        }
                                        // temp_date = dt1.AddDays(date_loop);
                                        date_loop++;
                                ...
                                tagnotedr = tagnotedt.NewRow();
                                tagnotedt.Rows.Add(tagnotedr);
                                for (int ji = 0; ji < tagnotedt.Columns.Count; ji++)
                                {
                                    tagnotedt.Rows[0][ji] = Convert.ToString(rowtag[ji]);
                                }
                                Session["tagnotedt"] = tagnotedt;
                                int temp = 0;//1
                                ...
                                for (Att_mark_row = 1; Att_mark_row < attendt.Rows.Count - 2; Att_mark_row++)
                                {
                                    attendatadr = attendatadt.NewRow();
                                    attendatatagdr = attendatatag.NewRow();
                                    
                                    rollno_Att = attendt.Rows[Att_mark_row + 2][3].ToString();// gview.Rows[Att_mark_row + 2].Cells[3].Text;
                                    
                                    for (Att_mark_column = 5; Att_mark_column < attendt.Columns.Count - 2; Att_mark_column++)
                                    {
                                        str_Date = Convert.ToString(row1[Att_mark_column + 2]); //gview.Rows[0].Cells[Att_mark_column + 2].Text;
                                        string[] tmpdate = str_Date.ToString().Split(new char[] { ' ' });
                                        str_Date = tmpdate[0].ToString();
                                        
                                        rollno_Att = attendt.Rows[Att_mark_row + 2][3].ToString();
                                        ...
                                        int Att_hour;
                                        Att_hour = Convert.ToInt32(row2[Att_mark_column + 2]);
                                        ...
                                        //=======================Student OD Lock
                                        DataTable dtOnduty = dirAcc.selectDataTable("select roll_no,Semester,Purpose,Fromdate,Todate,attnd_type,hourse,ISNULL(day,0) day from Onduty_Stud od where roll_no='" + rollno_Att + "'  and (convert(datetime,od.fromdate,105) >= '" + fDate + "' or  convert(datetime,od.Todate,105)>='" + tdate + "') and  (convert(datetime,od.fromdate,105) <='" + fDate + "' or convert(datetime,od.Todate,105)<= '" + tdate + "')");
                                        ...
                                        if (checkedFeeOfRoll)
                                        {
                                            ...
                                            attendatadr[Att_mark_column - 5] = "A-fe";
                                            attendatatagdr[Att_mark_column - 5] = "2";
                                        }
                                        else
                                        {
                                            if (hatsuspent.Contains(rollno_Att.Trim().ToLower()))
                                            {
                                                ...
                                                if (ds_suspend.Tables.Count > 0 && ds_suspend.Tables[0].Rows.Count > 0)
                                                {
                                                    ...
                                                    if ((Convert.ToInt32(daycon + daycon1) == totalactdays - 1) && (daycon >= 0))
                                                    {
                                                        ...
                                                        attendatadr[Att_mark_column - 5] = "S";
                                                        attendatatagdr[Att_mark_column - 5] = "9";
                                                    }
                                                    else
                                                    {
                                                        string admdate = attendt.Rows[Att_mark_row + 2][0].ToString();
                                                        string[] admspli = admdate.Split('$');
                                                        DateTime dtadm = Convert.ToDateTime(admspli[1]);
                                                        if (dtadm <= dtcurdate)
                                                        {
                                                            ...
                                                            {
                                                                dtOnduty.DefaultView.RowFilter = "Roll_no='" + rollno_Att + "' and day='" + dtcurdate + "''";
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    dtOnduty.DefaultView.RowFilter = "Roll_no='" + rollno_Att + "' and  (Fromdate>='" + dtcurdate + "' or  Todate>='" + dtcurdate + "') and (Fromdate<='" + dtcurdate + "' or  Todate<='" + dtcurdate + "')";
                                                                    dvCount = dtOnduty.DefaultView;
                                                                }
                                                                if (dvCount.Count > 0)
                                                            ...
                                                            {
                                                                if (odPeriods.Contains(Att_hour.ToString()))
                                                                    isOD = true;
                                                            }
                                                            ...
                                                            if (dvatt.Count > 0)
                                                            {
                                                                ...
                                                                attendatadr[Att_mark_column - 5] = Att_Mark1.ToString();
                                                                if (isOD)
                                                                {
                                                                    attendatadr[Att_mark_column - 5] = Att_Mark1.ToString() + "-disabl";
                                                                }                                                                
                                                                attendatatagdr[Att_mark_column - 5] = Att_Markvalue.ToString();
                                                            }
                                                        }
                                                        else
                                                        {
                                                            ...
                                                            //FpSpread2.Sheets[0].Cells[Att_mark_row, Att_mark_column].Locked = true;
                                                            attendatadr[Att_mark_column - 5] = "NJ";
                                                            attendatatagdr[Att_mark_column - 5] = "8";
                                                        }
                                                    }
                                                }
                                            }
                                            else
                                            {
                                                string admdate = attendt.Rows[Att_mark_row + 2][0].ToString();
                                                string[] admspli = admdate.Split('$');
                                                DateTime dtadm = Convert.ToDateTime(admspli[1]);// FpSpread2.Sheets[0].Cells[Att_mark_row, 4].Tag.ToString());
                                                if (dtadm <= dtcurdate)
                                                {
                                                    DataView dvCount = new DataView();
                                                    string odPeriods = string.Empty;
                                                    if (dtOnduty.Rows.Count > 0)
                                                    {
                                                        ...
                                                        dtOnduty.DefaultView.RowFilter = "Roll_no='" + rollno_Att + "' and  (Fromdate>='" + dtcurdate + "' or  Todate>='" + dtcurdate + "') and (Fromdate<='" + dtcurdate + "' or  Todate<='" + dtcurdate + "') and (Day='" + dtcurdate + "' or Day='01/01/1900')";//day
                                                        dvCount = dtOnduty.DefaultView;
                                                        if (dvCount.Count > 0)
                                                            odPeriods = Convert.ToString(dvCount[0]["hourse"]);
                                                    }
                                                    ...
                                                    if (dvatt.Count > 0)
                                                    {
                                                        ...
                                                        attendatadr[Att_mark_column - 5] = Att_Mark1.ToString();
                                                        if (isOD && !string.IsNullOrEmpty(Att_Mark1))
                                                        {
                                                            attendatadr[Att_mark_column - 5] = Att_Mark1.ToString() + "-disabl";
                                                        }
                                                        attendatatagdr[Att_mark_column - 5] = Att_Markvalue.ToString();
                                    ...
                                    attendatadt.Rows.Add(attendatadr);
                                    attendatatag.Rows.Add(attendatatagdr);
                                }
                                if (temp > 0)
                                {
                        ...
                        else
                        {
                            ...
                            attendr = attendt.NewRow();
                            attendr["Student Name"] = "No Of Student(s) Present:";
                            attendt.Rows.Add(attendr);
                            attendr = attendt.NewRow();
                            attendr["Student Name"] = "No Of Student(s) Absent:";
                            attendt.Rows.Add(attendr);//day
                            ...
                            for (Att_mark_column = 7; Att_mark_column < attendt.Columns.Count; Att_mark_column++)
                            {
                                absent_count = 0;
                                present_count = 0;
                                //for (Att_mark_row = 1; Att_mark_row < FpSpread2.Sheets[0].RowCount - 2; Att_mark_row++)
                                for (Att_mark_row = 3; Att_mark_row < attendt.Rows.Count - 2; Att_mark_row++)
                                {
                                    if (attendatadt.Rows[Att_mark_row - 3][Att_mark_column - 7].ToString() != "")
                                    //if (FpSpread2.Sheets[0].Cells[Att_mark_row, Att_mark_column].Text.ToString() != "")
                                    {
                                        if (present_calcflag.ContainsKey(attendatatag.Rows[Att_mark_row - 3][Att_mark_column - 7].ToString()))// FpSpread2.Sheets[0].Cells[Att_mark_row, Att_mark_column].Tag.ToString()))
                                        //if (present_calcflag.ContainsKey(FpSpread2.Sheets[0].Cells[Att_mark_row, Att_mark_column].Tag.ToString()))
                                        {
                                            present_count++;
                                        }
                                        if (absent_calcflag.ContainsKey(attendatatag.Rows[Att_mark_row - 3][Att_mark_column - 7].ToString()))
                                ...
                                attendt.Rows[attendt.Rows.Count - 2][Att_mark_column] = present_count.ToString();
                                attendt.Rows[attendt.Rows.Count - 1][Att_mark_column] = absent_count.ToString();
                            }

                            Session["attendt"] = attendt;
                            Session["tagnotedt"] = tagnotedt;
                            gview.DataSource = attendt;
                            gview.DataBind();
                            gview.Visible = true;
                            gview.Rows[gview.Rows.Count - 2].BackColor = Color.MistyRose; gview.Rows[gview.Rows.Count - 2].HorizontalAlign = HorizontalAlign.Center;
                            gview.Rows[gview.Rows.Count - 1].BackColor = Color.MistyRose; gview.Rows[gview.Rows.Count - 1].HorizontalAlign = HorizontalAlign.Center;

                            //gview.Rows[gview.Rows.Count - 2].Cells[1].ColumnSpan = 5;
                            gview.Rows[gview.Rows.Count - 2].Cells[1].BorderColor = Color.MistyRose;
                            gview.Rows[gview.Rows.Count - 2].Cells[2].BorderColor = Color.MistyRose;
                            gview.Rows[gview.Rows.Count - 2].Cells[3].BorderColor = Color.MistyRose;
                            gview.Rows[gview.Rows.Count - 2].Cells[4].BorderColor = Color.MistyRose;
                            gview.Rows[gview.Rows.Count - 2].Cells[5].BorderColor = Color.MistyRose;
                            gview.Rows[gview.Rows.Count - 2].Cells[6].BorderColor = Color.Black;

                            //gview.Rows[gview.Rows.Count - 1].Cells[1].ColumnSpan = 5;
                            gview.Rows[gview.Rows.Count - 1].Cells[1].BorderColor = Color.MistyRose;
                            gview.Rows[gview.Rows.Count - 1].Cells[2].BorderColor = Color.MistyRose;
                            gview.Rows[gview.Rows.Count - 1].Cells[3].BorderColor = Color.MistyRose;
                            gview.Rows[gview.Rows.Count - 1].Cells[4].BorderColor = Color.MistyRose;
                            gview.Rows[gview.Rows.Count - 1].Cells[5].BorderColor = Color.MistyRose;
                            gview.Rows[gview.Rows.Count - 1].Cells[6].BorderColor = Color.Black;
                            for (int t1 = 0; t1 < gview.Rows[0].Cells.Count; t1++)
                            {
                                string st = gview.Rows[0].Cells[t1].Text;
                            }
                            for (int row = 2; row < gview.Rows.Count - 2; row++)
                            {
                                for (int comb = 1; comb < gview.HeaderRow.Cells.Count - 6; comb++)
                                {
                                    if (row == 2)
                                    {
                                        DropDownList ddlall = (gview.Rows[row].FindControl("ddlmodeall_" + comb) as DropDownList);
                                        ddlall.DataSource = strcomo1adt;
                                        ddlall.DataTextField = "atten";
                                        ddlall.DataValueField = "atten";
                                        ddlall.DataBind();
                                    }
                                    if (row != 2)
                                    {
                                        DropDownList ddlcols = (gview.Rows[row].FindControl("ddlcmode_" + 1) as DropDownList);
                                        ddlcols.DataSource = strcomo1dt;
                                        ddlcols.DataTextField = "atten";
                                        ddlcols.DataValueField = "atten";
                                        ddlcols.DataBind();

                                        DropDownList ddlcol = (gview.Rows[row].FindControl("ddlmode_" + comb) as DropDownList);
                                        ddlcol.DataSource = strcomo1dt;
                                        ddlcol.DataTextField = "atten";
                                        ddlcol.DataValueField = "atten";
                                        ddlcol.DataBind();
                                    }
                                }
                            }
                            for (int ii = 0; ii < gview.Rows.Count; ii++)
                            {
                                gview.Rows[ii].Cells[6].Visible = false;
                                gview.Rows[ii].Cells[0].Visible = false;
                            }
                            for (int vale = 0; vale < attendatadt.Rows.Count; vale++)
                            {
                                if (vale == 0)
                                {
                                    //RowSpan
                                    ...
                                    for (int ij = 0; ij < row.Cells.Count; ij++)
                                    {
                                        if (row.Cells[ij].Text == previousRow.Cells[ij].Text)
                                        {
                                            row.Cells[ij].RowSpan = previousRow.Cells[ij].RowSpan < 2 ? 2 :
                                                                   previousRow.Cells[ij].RowSpan + 1;
                                            previousRow.Cells[ij].Visible = false;
                                        }
                                    }
                                    //ColumnSpan
                                    for (int cell = gview.Rows[0].Cells.Count - 1; cell >= 7; cell--)
                                    {
                                ...
                                for (int col = 0; col < attendatadt.Columns.Count; col++)
                                {
                                    int coll = col + 1;
                                    string atten = attendatadt.Rows[vale][col].ToString();
                                    string disabl = string.Empty;
                                    string[] splt = atten.Split('-');
                                    if (splt.Length == 2)
                                    {
                                        atten = splt[0];
                                        disabl = splt[1];
                                    }
                                    (gview.Rows[vale + 3].FindControl("ddlmode_" + (col + 1)) as DropDownList).SelectedIndex = (gview.Rows[vale + 3].FindControl("ddlmode_" + (col + 1)) as DropDownList).Items.IndexOf((gview.Rows[vale + 3].FindControl("ddlmode_" + (col + 1)) as DropDownList).Items.FindByValue(atten));
                                    if (disabl == "disabl")
                                    {
                                        (gview.Rows[vale + 3].FindControl("ddlmode_" + (col + 1)) as DropDownList).Enabled = false;
                                    }
                                    else if (disabl == "fe")
                                    {
                                        (gview.Rows[vale + 3].FindControl("ddlmode_" + (col + 1)) as DropDownList).Enabled = false;
                            ...
                            for (int ji = 3; ji < gview.Rows.Count - 2; ji++)
                            {
                                gview.Rows[ji].Cells[1].HorizontalAlign = HorizontalAlign.Center; gview.Rows[ji].Cells[3].HorizontalAlign = HorizontalAlign.Center;
                                gview.Rows[ji].Cells[4].HorizontalAlign = HorizontalAlign.Center;
                                if (gview.Rows[ji].Cells[6].Text.ToLower() == "hostler")
                                {
                                    gview.Rows[ji].Cells[0].BackColor = Color.LightYellow;
                                    gview.Rows[ji].Cells[1].BackColor = Color.LightYellow;
                                    gview.Rows[ji].Cells[3].BackColor = Color.LightYellow;
                                    gview.Rows[ji].Cells[4].BackColor = Color.LightYellow;
                                    gview.Rows[ji].Cells[5].BackColor = Color.LightYellow;
                                    gview.Rows[ji].Cells[6].BackColor = Color.LightYellow;
                                }
                                else if (list.Contains(ji))
                                {
                                    gview.Rows[ji].Cells[0].BackColor = Color.Red;
                                    gview.Rows[ji].Cells[1].BackColor = Color.Red;
                                    gview.Rows[ji].Cells[3].BackColor = Color.Red;
                                    gview.Rows[ji].Cells[4].BackColor = Color.Red;
                                    gview.Rows[ji].Cells[5].BackColor = Color.Red;
                                    gview.Rows[ji].Cells[6].BackColor = Color.Red;
                                    gview.Rows[ji].Enabled = false;
                                }
                                else
                                {
                                    gview.Rows[ji].Cells[0].BackColor = Color.MediumSeaGreen;
                                    gview.Rows[ji].Cells[1].BackColor = Color.MediumSeaGreen;
                                    gview.Rows[ji].Cells[3].BackColor = Color.MediumSeaGreen;
                                    gview.Rows[ji].Cells[4].BackColor = Color.MediumSeaGreen;
                                    gview.Rows[ji].Cells[5].BackColor = Color.MediumSeaGreen;
                                    gview.Rows[ji].Cells[6].BackColor = Color.MediumSeaGreen;
                                }
                                string roll = gview.Rows[ji].Cells[3].Text;
                                if (dicFeeOfRollStudents.ContainsKey(roll.Trim()))
                                {
                                    //gview.Rows[ji].BackColor = Color.Red;
                                    gview.Rows[ji].Cells[0].BackColor = Color.Red;
                                    gview.Rows[ji].Cells[1].BackColor = Color.Red;
                                    gview.Rows[ji].Cells[3].BackColor = Color.Red;
                                    gview.Rows[ji].Cells[4].BackColor = Color.Red;
    ...
    protected void gview_OnRowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (e.Row.RowIndex == 0)
                {
                    attndt = (DataTable)Session["attendt"];
                    for (int i = 0; i < e.Row.Cells.Count; i++)
                    {
                        e.Row.Cells[i].Text = Convert.ToString(row1[i]);
                        e.Row.BackColor = ColorTranslator.FromHtml("#0CA6CA");
                        e.Row.Cells[i].Font.Name = "Book Antique";
                ...
                else if (e.Row.RowIndex == 1)
                {
                    ...
                    {
                        e.Row.Cells[j].Text = Convert.ToString(row2[j]);
                        e.Row.BackColor = ColorTranslator.FromHtml("#0CA6CA");
                ...
                {
                    for (int cell = 7; cell < e.Row.Cells.Count; cell++)
                    {
                        DropDownList ddlmodeall = new DropDownList();
                        ddlmodeall.Width = 90;
                        ddlmodeall.BackColor = Color.MistyRose;
                        //ddlmodeall.AutoPostBack = true;
                        ddlmodeall.ID = "ddlmodeall_" + (cell - 6);
                        e.Row.Cells[cell].Controls.Add(ddlmodeall);

                        ((DropDownList)e.Row.FindControl("ddlmodeall_" + (cell - 6))).Attributes.Add("onchange",
                            "javascript:SelectAll('" +
                            ((DropDownList)e.Row.FindControl("ddlmodeall_" + (cell - 6))).ClientID + "')");
                    }
                }
                else if (e.Row.RowIndex < attndt.Rows.Count - 2)
                {
                    DropDownList ddlcmode = new DropDownList();
                    ddlcmode.Width = 90;
                    ddlcmode.BackColor = Color.MistyRose;
                    //ddlcmode.AutoPostBack = true;
                    ddlcmode.ID = "ddlcmode_" + (1);
                    e.Row.Cells[2].Controls.Add(ddlcmode);

                    ((DropDownList)e.Row.FindControl("ddlcmode_" + (1))).Attributes.Add("onchange",
                            "javascript:SelectCAll('" +
                            ((DropDownList)e.Row.FindControl("ddlcmode_" + (1))).ClientID + "')");

                    for (int cell = 7; cell < e.Row.Cells.Count; cell++)
                    {
                        DropDownList ddlmode = new DropDownList();
                        ddlmode.Width = 90;
                        ddlmode.BackColor = Color.MistyRose;
                        //ddlmode.AutoPostBack = true;
                        ddlmode.ID = "ddlmode_" + (cell - 6);
                        e.Row.Cells[cell].Controls.Add(ddlmode);
                    }
                }
            }
        }
    ...
    protected void gview_OnDataBound(object sender, EventArgs e)
    {
        try
        {
            //for (int i = gview.Rows.Count - 2; i < gview.Rows.Count; i++)
            //{
            //    for (int ji = 0; ji < gview.Rows[i].Cells.Count; ji++)
            //    {
            //        if (ji < 7)
            //        {
            //            gview.Rows[i].BackColor = Color.MistyRose;
            //            gview.Rows[i].HorizontalAlign = HorizontalAlign.Center;
            //        }
            //        else
            //        {
            //            gview.Rows[i].Cells[ji].Text = "";
            //            gview.Rows[i].HorizontalAlign = HorizontalAlign.Center;
            //        }
            //    }
            //    //gview.Rows[i].Cells[1].ColumnSpan = 5;
            //    //gview.Rows[i].Cells[2].Visible = false;
    ...
    protected void Buttonsave_Click(object sender, EventArgs e)
    {
        try
        {
            DataTable tagnotdt = (DataTable)Session["tagnotedt"];
            ...
            for (int Att_row = 1; Att_row < gview.Rows.Count - 4; Att_row++)
            {
                ...
                for (int Att_column = 5; Att_column < gview.HeaderRow.Cells.Count - 2; Att_column++)
                {
                    ...
                    str_hour = gview.Rows[1].Cells[Att_column + 2].Text;
                    ...
                    DropDownList ddl = (gview.Rows[Att_row + 2].FindControl("ddlmode_" + (Att_column - 4)) as DropDownList);
                    Att_mark = ddl.SelectedItem.Text;
                    getvalue = Attvalues(Att_mark);
    ...
    protected void Buttonselectall_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (gview.Rows.Count > 3)
            {
                ...
                for (int row = 3; row < gview.Rows.Count - 2; row++)
                {
                    for (int col = 7; col < gview.Rows[row].Cells.Count; col++)
                    {
                        DropDownList ddlmode = (gview.Rows[row].FindControl("ddlmode_" + (col - 6)) as DropDownList);
                        string modee = ddlmode.SelectedItem.Text;
                        //if (FpSpread2.Sheets[0].Cells[row, col].Text != "S" && FpSpread2.Sheets[0].Cells[row, col].Text.ToUpper() != "OD")//condn added 09.08.12
                        if (modee != "S" && modee != "OD")//condn added 09.08.12
                        {
                            //if (FpSpread2.Sheets[0].Cells[row, col].Locked == false)
                            if (ddlmode.Enabled)
                            {
                                (gview.Rows[row].FindControl("ddlmode_" + (col - 6)) as DropDownList).SelectedIndex = (gview.Rows[row].FindControl("ddlmode_" + (col - 6)) as DropDownList).Items.IndexOf((gview.Rows[row].FindControl("ddlmode_" + (col - 6)) as DropDownList).Items.FindByValue("P"));
                ...
                //for (Att_mark_column = 5; Att_mark_column < FpSpread2.Sheets[0].ColumnCount; Att_mark_column++)
                for (Att_mark_column = 7; Att_mark_column < gview.HeaderRow.Cells.Count; Att_mark_column++)
                {
                    absent_count = 0;
                    present_count = 0;

                    //for (Att_mark_row = 1; Att_mark_row < FpSpread2.Sheets[0].RowCount - 2; Att_mark_row++)
                    for (Att_mark_row = 3; Att_mark_row < gview.Rows.Count - 2; Att_mark_row++)
                    {
                        DropDownList ddl = (gview.Rows[Att_mark_row].FindControl("ddlmode_" + (Att_mark_column - 6)) as DropDownList);
                        string PandAcont = ddl.SelectedItem.Text;
                        ...
                        if (PandAcont != "" && PandAcont != " " && PandAcont != null) //condn 09.08.12 mythili
                        {
                            string getvalue = Attvalues(PandAcont);// FpSpread2.Sheets[0].Cells[Att_mark_row, Att_mark_column].Text.ToString());
                    ...
                    gview.Rows[gview.Rows.Count - 2].Cells[Att_mark_column].Text = present_count.ToString();
                    gview.Rows[gview.Rows.Count - 1].Cells[Att_mark_column].Text = absent_count.ToString();
            ...
            if (gview.Rows.Count > 3)
            {
                ...
                for (int row = 3; row < gview.Rows.Count - 2; row++)
                {
                    ...
                    for (int col = 7; col < gview.Rows[row].Cells.Count; col++)
                    {
                        ...
                        {
                            //if (FpSpread2.Sheets[0].Cells[row, col].Locked == false)
                            if (ddlmode.Enabled == true)
                            {
                                (gview.Rows[row].FindControl("ddlmode_" + (col - 6)) as DropDownList).SelectedIndex = (gview.Rows[row].FindControl("ddlmode_" + (col - 6)) as DropDownList).Items.IndexOf((gview.Rows[row].FindControl("ddlmode_" + (col - 6)) as DropDownList).Items.FindByValue(" "));
    ...
    {
        Double totalRows = 0;
        totalRows = gview.Rows.Count;
        Session["totalPages"] = "2";// (int)Math.Ceiling(totalRows /gview.PageSize;
    ...
    protected void btnsliplist_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable headtag = (DataTable)Session["tagnotedt"];
            ...
            //sliplistdt.Columns.Add("S.No");
            sliplistdt.Columns.Add("Date");
            sliplistdt.Columns.Add("Hour");
            sliplistdt.Columns.Add("Staff Name");
            sliplistdt.Columns.Add("Subject");
            ...
            int snlo = 0;
            for (colcnt = 5; colcnt < gview.HeaderRow.Cells.Count - 2; colcnt++)
            {
                DateTime temp_date = new DateTime();
                date_txt = headtag.Rows[0][colcnt + 2].ToString();// headtag.Columns[colcnt + 2].ColumnName.ToString();// FpSpread2.Sheets[0].ColumnHeader.Cells[1, colcnt].Tag.ToString();
                temp_hr = Convert.ToInt32(gview.Rows[1].Cells[colcnt + 2].Text);// Convert.ToInt16(FpSpread2.Sheets[0].ColumnHeader.Cells[1, colcnt].Text.ToString());
                                    ...
                                    if (altschedule == false)
                                    {
                                        ...
                                        for (int st = 1; st < sem_sched_split_split1.GetUpperBound(0); st++)
                                        {
                                            if (sem_sched_split_split1[st].ToString().Trim() != "")
                                            {
                                                ...
                                                //sliplistdr["S.No"] = snlo.ToString();
                                                sliplistdr["Date"] = Convert.ToDateTime(date_txt).ToString("dd/MM/yyyy");
                                                sliplistdr["Hour"] = gview.Rows[1].Cells[colcnt + 2].Text; //Convert.ToDateTime(date_txt).ToString("dd/MM/yyyy");
                                                sliplistdr["Staff Name"] = GetFunction("select staff_name from staffmaster where staff_code='" + sem_sched_split_split1[st].ToString() + "'");
                                                sliplistdr["Subject"] = subname;

                                                sliplistdt.Rows.Add(sliplistdr);
                                ...
                                for (int temp_sem_split = 0; temp_sem_split <= sem_sched_split.GetUpperBound(0); temp_sem_split++)
                                {
                                    ...
                                    if (altschedule == false)
                                    {
                                        ...
                                        for (int st = 1; st < sem_sched_split_split.GetUpperBound(0); st++)
                                        {
                                            ...
                                            {
                                                slno++;
                                                sliplistdr = sliplistdt.NewRow();
                                                //sliplistdr["S.No"] = slno.ToString();
                                                sliplistdr["Date"] = Convert.ToDateTime(date_txt).ToString("dd/MM/yyyy");
                                                sliplistdr["Hour"] = gview.Rows[1].Cells[colcnt + 2].Text; //Convert.ToDateTime(date_txt).ToString("dd/MM/yyyy");
                                                sliplistdr["Staff Name"] = GetFunction("select staff_name from staffmaster where staff_code='" + sem_sched_split_split[st].ToString() + "'");
                                                sliplistdr["Subject"] = subname;
                                                sliplistdt.Rows.Add(sliplistdr);
            ...
            gviewsliplist.DataSource = sliplistdt;
            gviewsliplist.DataBind();
            pnl_sliplist.Visible = true;
            gviewsliplist.Visible = true;
    ...
    public void attendacesavefunction()
    {
        try
        {
            ...
            if (txtFromDate.Text != "" && TxtToDate.Text != "")
            {
                ...
                if (gview.HeaderRow.Cells.Count > 1)
                {
                    if (ckmanual.Checked == true)
                    {
                        ...
                        for (int Att_row = 1; Att_row < gview.Rows.Count - 4; Att_row++)
                        {
                            str_rollno1 = gview.Rows[Att_row + 2].Cells[3].Text;
                            //str_rollno1 = FpSpread2.Sheets[0].Cells[Att_row, 1].Text.ToString();
                            //for (int Att_column = 5; Att_column <= FpSpread2.Sheets[0].ColumnCount - 1; Att_column++)
                            for (int Att_column = 5; Att_column <= gview.HeaderRow.Cells.Count - 3; Att_column++)
                            {
                                str_Date1 = headtag.Columns[Att_column + 2].ColumnName;
                                ...
                                str_hour1 = gview.Rows[1].Cells[Att_column + 2].Text;
                                ...
                                DropDownList ddl = (gview.Rows[Att_row + 2].FindControl("ddlmode_" + (Att_column - 4)) as DropDownList);
                                Att_mark1 = ddl.SelectedItem.Text;
                        ...
                        for (int Att_row = 1; Att_row < gview.Rows.Count - 4; Att_row++)
                        {
                            ...
                            for (int Att_column = 5; Att_column < gview.HeaderRow.Cells.Count - 2; Att_column++)
                            {
                                ...
                                if (!isDis)
                                {
                                    int cool = headtag.Columns.Count;
                                    string app = gview.Rows[Att_row + 2].Cells[0].Text;
                                    string[] spl = app.Split('$');
                                    appNo = spl[0];
                                    //appNo = FpSpread2.Sheets[0].GetTag(Att_row, 1).ToString();
                                    //str_Date = FpSpread2.Sheets[0].ColumnHeader.GetClipValue(0, Att_column, 1, 1);
                                    str_Date = headtag.Columns[Att_column + 2].ColumnName;
                                    Splitmondate = str_Date.ToString();
                                    string[] split = Splitmondate.Split(new Char[] { '-' });
                                    str_day = split[0].ToString();
                                    Atmonth = split[1].ToString();
                                    Atyear = split[2].ToString();
                                    strdate = (Convert.ToInt32(Atmonth) + Convert.ToInt32(Atyear) * 12);
                                    str_hour = Convert.ToString(headtag.Rows[0][Att_column + 2]);
                                    //str_hour = FpSpread2.Sheets[0].ColumnHeader.GetClipValue(1, Att_column, 1, 1);
                                    string[] split_hr = str_hour.Split(new Char[] { '-' });
                                    str_hour = str_hour[0].ToString();
                                    ...
                                    if (monthandyear != strdate.ToString() || Att_column == gview.HeaderRow.Cells.Count - 3)
                                    {
                                        hat.Clear();
                    ...
                    else // start last modify jairam  // 03-09-2014
                    {
                        ...
                        for (int Att_row = 1; Att_row < gview.Rows.Count - 4; Att_row++)
                        {
                            ...
                            if (!isdis)
                            {
                                ...
                                //tagnote = gview.Rows[Att_row + 2].Cells[0].Text;
                                //string[] spl = tagnote.Split('$');
                                //appNo = spl[0];
                                //for (int Att_column = 5; Att_column <= FpSpread2.Sheets[0].ColumnCount - 1; Att_column++)
                                for (int Att_column = 5; Att_column < gview.HeaderRow.Cells.Count - 2; Att_column++)
                                {
                                    ...
                                    if (monthandyear != strdate.ToString() || Att_column == gview.HeaderRow.Cells.Count - 3)// FpSpread2.Sheets[0].ColumnCount - 1
                                    {
                                        if (existattndval != updatevalues)
                                        {
                                            hat.Clear();
                        ...
                        //for (Att_mark_column = 5; Att_mark_column < FpSpread2.Sheets[0].ColumnCount; Att_mark_column++)
                        for (Att_mark_column = 5; Att_mark_column < gview.HeaderRow.Cells.Count - 2; Att_mark_column++)
                        {
                            absent_count = 0;
                            present_count = 0;

                            //for (Att_mark_row = 1; Att_mark_row < FpSpread2.Sheets[0].RowCount - 2; Att_mark_row++)
                            for (Att_mark_row = 1; Att_mark_row < gview.Rows.Count - 4; Att_mark_row++)
                            {
                                DropDownList ddll = (gview.Rows[Att_mark_row + 2].FindControl("ddlmode_" + (Att_mark_column - 4)) as DropDownList);
                                string attnval1 = ddlbatch.SelectedItem.Text;
                                string attnval = ddll.SelectedItem.Text;
                                ...
                                if (attnval.Trim() != "" && attnval != null) //condn 09.08.12 mythili
                                {
                                    //string getvalue = Attvalues(FpSpread2.Sheets[0].Cells[Att_mark_row, Att_mark_column].Text.ToString());
                                    string getvalue = Attvalues(attnval);
                                    if (present_calcflag.ContainsKey(getvalue))
                                    {
                                        present_count++;
                                    }
                            ...
                            gview.Rows[gview.Rows.Count - 2].Cells[Att_mark_column + 2].Text = present_count.ToString();
                            gview.Rows[gview.Rows.Count - 1].Cells[Att_mark_column + 2].Text = absent_count.ToString();
                        }
                        if (savefalg == true)
                        {
    ...
    protected void btncopy_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ////for (int Att_row = 1; Att_row <= FpSpread2.Sheets[0].RowCount - 3; Att_row++)
            //for (int Att_row = 3; Att_row < gview.Rows.Count - 2; Att_row++)
            //{
            //    DropDownList ddllist = (gview.Rows[Att_row].FindControl("ddlmode_") as DropDownList);
            //    attend_value = ddllist.SelectedItem.Text;// FpSpread2.Sheets[0].Cells[Att_row, 5].Text;
