...
public partial class dailystudentattndreport : System.Web.UI.Page
{
    ...
    #region
    DataTable gviewtable = new DataTable();
    DataRow gviewdrrow = null;
    DataTable readmtable = new DataTable();
    DataRow readmrow = null;
    DataTable disconttable = new DataTable();
    DataRow discontrow = null;
    #endregion
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Session["gviewtable"] != null)
            {
                Session.Remove("gviewtable");
            }
        }
        callGridBind();
    }
    ...
    public void callGridBind()
    {
        if (Session["gviewtable"] != null)
        {
            DataTable gviewtab = (DataTable)Session["gviewtable"];
    ...
    public void loadattendanceNew()
    {
        try
        {
            ...
            gviewtable.Rows.Clear();
            gviewtable.Clear();
            DataTable gviewatten = new DataTable();
            DataRow gviewattnrow = null;
            Hashtable freeHr = new Hashtable();
            Hashtable specialHr = new Hashtable();
            ...
            //strcomo1 = new string[] { "Select for All ", " ", "P", "A", "OD", "SOD", "ML", "NSS", "L", "NJ", "S", "NCC", "HS", "PP", "SYOD", "COD", "OOD", "LA", "RAA" };
            //strcomo = new string[] { " ", "P", "A", "OD", "SOD", "ML", "NSS", "L", "NJ", "S", "NCC", "HS", "PP", "SYOD", "COD", "OOD", "LA", "RAA" };
            DataTable dtcomo = new DataTable(); dtcomo.Columns.Add("Mark");
            DataTable dtcomo1 = new DataTable(); dtcomo1.Columns.Add("Mark");
            DataRow drcomo = dtcomo.NewRow(); drcomo["Mark"] = "Select for All"; dtcomo.Rows.Add(drcomo); drcomo = dtcomo.NewRow(); drcomo["Mark"] = " "; dtcomo.Rows.Add(drcomo);
            drcomo = dtcomo.NewRow(); drcomo["Mark"] = "P"; dtcomo.Rows.Add(drcomo); drcomo = dtcomo.NewRow(); drcomo["Mark"] = "A"; dtcomo.Rows.Add(drcomo);
            drcomo = dtcomo.NewRow(); drcomo["Mark"] = "OD"; dtcomo.Rows.Add(drcomo); drcomo = dtcomo.NewRow(); drcomo["Mark"] = "SOD"; dtcomo.Rows.Add(drcomo);
            drcomo = dtcomo.NewRow(); drcomo["Mark"] = "ML"; dtcomo.Rows.Add(drcomo); drcomo = dtcomo.NewRow(); drcomo["Mark"] = "NSS"; dtcomo.Rows.Add(drcomo);
            drcomo = dtcomo.NewRow(); drcomo["Mark"] = "L"; dtcomo.Rows.Add(drcomo); drcomo = dtcomo.NewRow(); drcomo["Mark"] = "NJ"; dtcomo.Rows.Add(drcomo);
            drcomo = dtcomo.NewRow(); drcomo["Mark"] = "S"; dtcomo.Rows.Add(drcomo); drcomo = dtcomo.NewRow(); drcomo["Mark"] = "NCC"; dtcomo.Rows.Add(drcomo);
            drcomo = dtcomo.NewRow(); drcomo["Mark"] = "HS"; dtcomo.Rows.Add(drcomo); drcomo = dtcomo.NewRow(); drcomo["Mark"] = "PP"; dtcomo.Rows.Add(drcomo);
            drcomo = dtcomo.NewRow(); drcomo["Mark"] = "SYOD"; dtcomo.Rows.Add(drcomo); drcomo = dtcomo.NewRow(); drcomo["Mark"] = "COD"; dtcomo.Rows.Add(drcomo);
            drcomo = dtcomo.NewRow(); drcomo["Mark"] = "OOD"; dtcomo.Rows.Add(drcomo); drcomo = dtcomo.NewRow(); drcomo["Mark"] = "LA"; dtcomo.Rows.Add(drcomo);
            drcomo = dtcomo.NewRow(); drcomo["Mark"] = "RAA"; dtcomo.Rows.Add(drcomo);
            DataRow drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = " "; dtcomo1.Rows.Add(drcomo1);
            drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "P"; dtcomo1.Rows.Add(drcomo1); drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "A"; dtcomo1.Rows.Add(drcomo1);
            drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "OD"; dtcomo1.Rows.Add(drcomo1); drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "SOD"; dtcomo1.Rows.Add(drcomo1);
            drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "ML"; dtcomo1.Rows.Add(drcomo1); drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "NSS"; dtcomo1.Rows.Add(drcomo1);
            drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "L"; dtcomo1.Rows.Add(drcomo1); drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "NJ"; dtcomo1.Rows.Add(drcomo1);
            drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "S"; dtcomo1.Rows.Add(drcomo1); drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "NCC"; dtcomo1.Rows.Add(drcomo1);
            drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "HS"; dtcomo1.Rows.Add(drcomo1); drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "PP"; dtcomo1.Rows.Add(drcomo1);
            drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "SYOD"; dtcomo1.Rows.Add(drcomo1); drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "COD"; dtcomo1.Rows.Add(drcomo1);
            drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "OOD"; dtcomo1.Rows.Add(drcomo1); drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "LA"; dtcomo1.Rows.Add(drcomo1);
            drcomo1 = dtcomo1.NewRow(); drcomo1["Mark"] = "RAA"; dtcomo1.Rows.Add(drcomo1);
            ds3.Clear();
            hat.Clear();
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    readmtable.Columns.Add("Readmission");
       ...
       , out Discontin);
                ...
                else
                {
                    ...
                    if (discon != "0" && discon != "")
                    {
                        disconttable.Columns.Add("Discontinue");
...
, out Discontin);
                ...
                if (ds3.Tables.Count > 0 && ds3.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (nohrs != null)
                    {
                        ...
                        //attnd_report.Sheets[0].ColumnHeader.Columns[0].HorizontalAlign = HorizontalAlign.Left;
                        //attnd_report.Sheets[0].ColumnHeaderSpanModel.Add(0, 0, 1, nohrs);
                        gviewtable.Columns.Add("tagnote");
                        row1.Add("S.No");
                        row2.Add("");
                        gviewtable.Columns.Add("S.No");
                        if (forschoolsetting == true)
                        {
                            //attnd_report.Sheets[0].ColumnHeader.Cells[0, 0].Text = "         " + "Standard:" + batchyear + "-" + coursename + "[" + deptname + "]" + "-" + "Term  " + sem + "    " + strsec + "  RollNo:" + rollno + "  Name :" + studentname;
                            row1.Add("         " + "Standard:" + batchyear + "-" + coursename + "[" + deptname + "]" + "-" + "Term  " + sem + "    " + strsec + "  RollNo:" + rollno + "  Name :" + studentname);
                        }
                        else
                        {
                            //attnd_report.Sheets[0].ColumnHeader.Cells[0, 0].Text = "         " + "Degree:" + batchyear + "-" + coursename + "[" + deptname + "]" + "-" + "Sem  " + sem + "    " + strsec + "  RollNo:" + rollno + "  Name :" + studentname;
                            row1.Add("         " + "Degree:" + batchyear + "-" + coursename + "[" + deptname + "]" + "-" + "Sem  " + sem + "    " + strsec + "  RollNo:" + rollno + "  Name :" + studentname);
                        }
                        //attnd_report.Sheets[0].ColumnHeader.Cells[1, 0].HorizontalAlign = HorizontalAlign.Center;
                        //attnd_report.Sheets[0].ColumnHeader.Cells[1, 0].VerticalAlign = VerticalAlign.Middle;
                        //attnd_report.Sheets[0].ColumnHeader.Cells[1, 0].Text = "Date";
                        gviewtable.Columns.Add("Date");
                        row2.Add("Date");
                        gviewatten.Columns.Add("Date");
                        ...
                        for (int i = 1; i <= nohrs; i++)
                        {
                            ...
                            //attnd_report.Sheets[0].Cells[0, i].CellType = objintcell;
                            // attnd_report.Sheets[0].Cells[0, 0].Locked = true;
                            gviewtable.Columns.Add(i.ToString());
                            row2.Add(i.ToString());
                            row1.Add("");
                            gviewatten.Columns.Add(i.ToString());
                        }
                        //attnd_report.Sheets[0].ColumnHeader.Columns.Count++;
                        //attnd_report.Sheets[0].ColumnHeader.Cells[1, nohrs + 1].Text = "Attendance Status";
                        //attnd_report.Sheets[0].Columns[nohrs + 1].BackColor = Color.Gray;
                        ...
                        //attnd_report.Sheets[0].Columns[0].Locked = true;
                        //attnd_report.Sheets[0].Columns[nohrs + 1].Locked = true;
                        gviewtable.Columns.Add("Attendance Status");
                        //gviewatten.Columns.Add("Attendance Status");

                        gviewdrrow = gviewtable.NewRow();
                        gviewtable.Rows.Add(gviewdrrow);
                        gviewdrrow = gviewtable.NewRow();
                        gviewtable.Rows.Add(gviewdrrow);
                        gviewdrrow = gviewtable.NewRow();
                        gviewtable.Rows.Add(gviewdrrow);

                        row2.Add("Attendance Status");
                        row1.Add("");
                        ...
                        //=======================Student OD Lock
                        DataTable dtOnduty = dirAcc.selectDataTable("select roll_no,Semester,Purpose,Fromdate,Todate,attnd_type,hourse,ISNULL(day,0) day from Onduty_Stud od where roll_no='" + get_rollno + "'  and (convert(datetime,od.fromdate,105) >= '" + fDate + "' or  convert(datetime,od.Todate,105)>='" + tdate + "') and  (convert(datetime,od.fromdate,105) <='" + fDate + "' or convert(datetime,od.Todate,105)<= '" + tdate + "')");
                        ...
                        }
                        {
                                ...
                                while (dummydate <= dt2)
                                {
                                    ...
                                    if (dummydate >= Admission_date)
                                    {
                                        ...
                                        if (holidayflag == false)
                                        {
                                            ...
                                            {
                                                dtOnduty.DefaultView.RowFilter = "Roll_no='" + get_rollno + "' and day='" + dummydate + "'";
                                                ...
                                                if (dvCount.Count > 0)//and (Day='" + dummydate + "' or Day='01/01/1900')
                                            ...
                                            //attnd_report.Sheets[0].RowCount++;
                                            gviewdrrow = gviewtable.NewRow();
                                            gviewattnrow = gviewatten.NewRow();
                                            gviewdrrow["S.No"] = sno.ToString();
                                            //attnd_report.Sheets[0].RowHeader.Cells[attnd_report.Sheets[0].RowCount - 1, 0].Text = (attnd_report.Sheets[0].RowCount - 1).ToString();
                                            //-----------------------lock row for attnd security
                                            chk = daycheck(Convert.ToDateTime(dummydate));
                                            if (chk == false)
                                            ...
                                            //attnd_report.Sheets[0].SetValue((attnd_report.Sheets[0].RowCount - 1), 0, Convert.ToString(date_text).Trim());
                                            //attnd_report.Sheets[0].Cells[attnd_report.Sheets[0].RowCount - 1, 0].Tag = Convert.ToString(dummy_split[0]).Trim();
                                            gviewdrrow["Date"] = Convert.ToString(date_text).Trim();
                                            gviewattnrow["Date"] = Convert.ToString(date_text).Trim();
                                            tagnote = tagnote + Convert.ToString(dummy_split[0]).Trim();
                                                ...
                                                if (dvStudentAttendance.Count > 0)
                                                {
                                                    ...
                                                    for (int temp = split_holiday_status_1; temp <= split_holiday_status_2; temp++)
                                                    {
                                                        ...
                                                        if (dicFeeOfRollStudents.ContainsKey(rollNo.Trim()) && dicFeeOnRollStudents.ContainsKey(rollNo.Trim()))
                                                        {
                                                            ...
                                                            dtSelDate = Convert.ToDateTime(dummydate);
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            if (dvStudentAttendance.Count > 0)
                                                            {
                                                                ...
                                                                if (!string.IsNullOrEmpty(valueAtt) && valueAtt != "" && valueAtt != "0" && valueAtt != "7")
                                                                {
                                                                    ...
                                                                    Attmark(leave_code);
                                                                    //attnd_report.Sheets[0].Cells[(attnd_report.Sheets[0].RowCount - 1), temp].Text = Att_mark;
                                                                    gviewattnrow[temp] = Att_mark;
                                                                    if (isOD && !string.IsNullOrEmpty(Att_mark))
                                                                    {
                                                                        gviewattnrow[temp] = Att_mark + "-disabl";
                                                                    }
                                                                    string clav = string.Empty;
                                                                    if (dicattval.ContainsKey(leave_code.Trim()))
                                                                    {
                                                                ...
                                                                if (freehr)
                                                                {
                                                                    ...
                                                                    if (!freeHr.ContainsKey(dummydate.ToString("dd/M/yyyy")))
                                                                    {
                                                                        freeHr.Add(dummydate.ToString("dd/M/yyyy"), "FH-" + temp);
                                                                    }
                                                                    else
                                                                    {
                                                                        string hr = Convert.ToString(freeHr[dummydate.ToString("dd/M/yyyy")]);
                                                                        freeHr[dummydate.ToString("dd/M/yyyy")] = hr + "-" + temp;
                                                                    }
                                                                }
                                                                else if (specialday)
                                                                {
                                                                    ...
                                                                    if (!freeHr.ContainsKey(dummydate.ToString("dd/M/yyyy")))
                                                                    {
                                                                        freeHr.Add(dummydate.ToString("dd/M/yyyy"), "SH-" + temp);
                                                                    }
                                                                    else
                                                                    {
                                                                        string hr = Convert.ToString(freeHr[dummydate.ToString("dd/M/yyyy")]);
                                                                    ...
                                                                    //if (!specialHr.ContainsKey(dummydate.ToString("dd/MM/yyyy")))
                                                                    //{
                                                                    //    specialHr.Add(dummydate.ToString("dd/MM/yyyy"), specialday + "-" + temp);
                                                                    //}
                                                                    //else
                                                                    //{
                                                                    //    string sphr = Convert.ToString(specialHr[dummydate.ToString("dd/MM/yyyy")]);
                                                                    //    specialHr[dummydate.ToString("dd/MM/yyyy")] = sphr + "$" + temp;
                                                                    //}
                                                    ...
                                                    //attnd_report.Sheets[0].Cells[(attnd_report.Sheets[0].RowCount - 1), forcount + 1].Text = attendance;
                                                    gviewdrrow["Attendance Status"] = attendance;
                                                    if (split_holiday_status_3 != 0 && split_holiday_status_4 != 0)
                                                    {
                                                        for (int holi_day = split_holiday_status_3; holi_day <= split_holiday_status_4; holi_day++)
                                                        {
                                                    ...
                                                    row_head_cnt++;
                                                    gviewtable.Rows.Add(gviewdrrow);
                                                    gviewatten.Rows.Add(gviewattnrow);
                                                }
                                                else
                                                {
                                                    gviewtable.Rows.Add(gviewdrrow);
                                            ...
                                            if (lbdiscontinue.Text != "")
                                            {
                                                ...
                                                {
                                                    readmrow = readmtable.NewRow();
                                                    if (Discontin <= dsdate && Readmin > dsdate)
                                                    {
                                                        //attnd_report.Sheets[0].Rows[attnd_report.Sheets[0].RowCount - 1].Locked = true;

                                                        if (readmtable.Columns.Count > 0)
                                                        {
                                                            //readmrow = readmtable.NewRow();
                                                            readmrow["Readmission"] = "Readm";
                                                            //readmtable.Rows.Add(readmrow);
                                                        }
                                                    }
                                                    readmtable.Rows.Add(readmrow);
                                                }
                                                else if (Discontin <= dsdate)
                                                {
                                                    ...
                                                    if (disconttable.Columns.Count > 0)
                                                    {
                                                        discontrow = disconttable.NewRow();
                                                        discontrow["Discontinue"] = "Discon";
                                                        disconttable.Rows.Add(discontrow);
                                                    }
                                                }
                                            }
                                        }
                            ...
                            //}
                            for (int tcell = 1; tcell < gviewtable.Columns.Count; tcell++)
                            {
                                gviewtable.Rows[0][tcell] = Convert.ToString(row1[tcell - 1]);
                                gviewtable.Rows[1][tcell] = Convert.ToString(row2[tcell - 1]);
                            }
                            Session["gviewtable"] = gviewtable;
                            //Session["gviewatten"] = gviewatten;
                            gview.DataSource = gviewtable;
                            gview.DataBind();
                            RowHead(gview, 2);
                            for (int span = 1; span < gviewtable.Columns.Count; span++)
                            {
                                gview.Rows[0].Cells[1].RowSpan = 2;
                                gview.Rows[1].Cells[1].Visible = false;
                                gview.Rows[0].Cells[2].ColumnSpan = gviewtable.Columns.Count - 2;
                                for (int vis = 3; vis < gviewtable.Columns.Count; vis++)
                                {
                                    gview.Rows[0].Cells[vis].Visible = false;
                                }
                            }
                            for (int vis = 0; vis < gview.Rows.Count; vis++)
                            {
                                gview.Rows[vis].Cells[0].Visible = false;
                            }

                            for (int row = 2; row < gview.Rows.Count; row++)
                            {
                                for (int comb = 1; comb < gview.HeaderRow.Cells.Count - 3; comb++)
                                {
                                    if (row != 2)
                                    {
                                        DropDownList ddl = (gview.Rows[row].FindControl("ddlmode_" + comb) as DropDownList);
                                        ddl.DataSource = dtcomo1;
                                        ddl.DataTextField = "Mark";
                                        ddl.DataValueField = "Mark";
                                        ddl.DataBind();
                                    }
                                    else
                                    {
                                        DropDownList ddlall = (gview.Rows[row].FindControl("ddlmodeall_" + comb) as DropDownList);
                                        ddlall.DataSource = dtcomo;
                                        ddlall.DataTextField = "Mark";
                                        ddlall.DataValueField = "Mark";
                                        ddlall.DataBind();
                                    }
                                }
                            }
                            for (int vale = 0; vale < gviewatten.Rows.Count; vale++)
                            {
                                for (int col = 1; col < gviewatten.Columns.Count; col++)
                                {
                                    string atten = gviewatten.Rows[vale][col].ToString();
                                    if (string.IsNullOrEmpty(atten))
                                    {
                                        atten = " ";
                                    }
                                    ...
                                    (gview.Rows[vale + 3].FindControl("ddlmode_" + col) as DropDownList).SelectedIndex = (gview.Rows[vale + 3].FindControl("ddlmode_" + col) as DropDownList).Items.IndexOf((gview.Rows[vale + 3].FindControl("ddlmode_" + col) as DropDownList).Items.FindByValue(atten));
                                    DropDownList ddlmode = (gview.Rows[vale + 3].FindControl("ddlmode_" + col) as DropDownList);
                                    if (ddlmode.SelectedItem.Text != atten)
                                    {
                                        ddlmode.Items.Insert(0, atten);
                                        (gview.Rows[vale + 3].FindControl("ddlmode_" + col) as DropDownList).SelectedIndex = (gview.Rows[vale + 3].FindControl("ddlmode_" + col) as DropDownList).Items.IndexOf((gview.Rows[vale + 3].FindControl("ddlmode_" + col) as DropDownList).Items.FindByValue(atten));
                                    }
                                    if (atten == "P")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#008000");
                                    }
                                    else if (atten == "A")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#FF0000");
                                    }
                                    else if (atten == "H")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#800000");
                                    }
                                    else if (atten == "OD")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#0000FF");
                                    }
                                    else if (atten == "SOD")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#adff2f");
                                    }
                                    else if (atten == "ML")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#E9967A");
                                    }
                                    else if (atten == "NSS")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#DAA520");
                                    }
                                    else if (atten == "L")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#0080ff");
                                    }
                                    else if (atten == "NCC")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#EE82EE");
                                    }
                                    else if (atten == "hs")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#708090");
                                    }
                                    else if (atten == "PP")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#FFC0CB");
                                    }
                                    else if (atten == "SYOD")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#32cd32");
                                    }
                                    else if (atten == "COD")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#D2B48C");
                                    }
                                    else if (atten == "OOD")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#f5deb3");
                                    }
                                    else if (atten == "NJ")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#8b4513");
                                    }
                                    else if (atten == "S")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#000000");
                                        ddlmode.Enabled = false;
                                    }
                                    else if (atten == "RAA")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#FFFF00");
                                    }
                                    else if (atten == "")
                                    {
                                        ddlmode.ForeColor = ColorTranslator.FromHtml("#7B68EE");
                                        ddlmode.BackColor = Color.MediumSlateBlue;
                                        if (readmtable.Rows.Count > 0)
                                        {
                                            if (readmtable.Rows[vale][0] == "Readm")
                                                ddlmode.Enabled = false;
                                        }
                                        else if (disconttable.Rows.Count > 0)
                                        {
                                            if (disconttable.Rows[vale][0] == "Discon")
                                                ddlmode.Enabled = false;
                                        }
                                    }
                                    else
                                    ...
                                    if (disabl == "fe")
                                    {
                                        gview.Rows[vale + 3].Cells[1].BackColor = Color.Red;
                                        gview.Rows[vale + 3].Cells[2].BackColor = Color.Red;
                                        ddlmode.Enabled = false;
                                    }
                                }
                            }
                            for (int dte = 0; dte < gviewatten.Rows.Count; dte++)
                            {
                                string date = Convert.ToString(gviewatten.Rows[dte][0]);
                                if (freeHr.ContainsKey(date))
                                {
                                    string[] val = Convert.ToString(freeHr[date]).Split('-');
                                    if (Convert.ToString(val[0]) == "FH")
                                    {
                                        for (int ji = 1; ji < val.Length; ji++)
                                        {
                                            DropDownList dddl = (gview.Rows[dte + 3].FindControl("ddlmode_" + Convert.ToString(val[ji])) as DropDownList);
                                            dddl.Items.Insert(dddl.Items.Count, "FH");
                                            (gview.Rows[dte + 3].FindControl("ddlmode_" + Convert.ToString(val[ji])) as DropDownList).SelectedIndex = (gview.Rows[dte + 3].FindControl("ddlmode_" + Convert.ToString(val[ji])) as DropDownList).Items.IndexOf((gview.Rows[dte + 3].FindControl("ddlmode_" + Convert.ToString(val[ji])) as DropDownList).Items.FindByValue("FH"));
                                            dddl.ForeColor = ColorTranslator.FromHtml("#FF00FF");
                                        }
                                    }
                                    else if (Convert.ToString(val[0]) == "SH")
                                    {
                                        for (int ji = 1; ji < val.Length; ji++)
                                        {
                                            DropDownList dddl = (gview.Rows[dte + 3].FindControl("ddlmode_" + Convert.ToString(val[ji])) as DropDownList);
                                            dddl.Items.Insert(dddl.Items.Count, "SH");
                                            (gview.Rows[dte + 3].FindControl("ddlmode_" + Convert.ToString(val[ji])) as DropDownList).SelectedIndex = (gview.Rows[dte + 3].FindControl("ddlmode_" + Convert.ToString(val[ji])) as DropDownList).Items.IndexOf((gview.Rows[dte + 3].FindControl("ddlmode_" + Convert.ToString(val[ji])) as DropDownList).Items.FindByValue("SH"));
                                            dddl.ForeColor = ColorTranslator.FromHtml("#432F5C");
                                        }
                                    }
                                }
                            }
    ...
    protected void gview_OnRowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            //DataTable attntable = (DataTable)Session["gviewatten"];
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (e.Row.RowIndex == 0 || e.Row.RowIndex == 1)
                {
                    for (int cell = 1; cell < e.Row.Cells.Count - 1; cell++)
                    {
                        e.Row.Cells[cell].HorizontalAlign = HorizontalAlign.Center;
                        e.Row.Cells[cell].Font.Bold = true;
                    }
                }
                else if (e.Row.RowIndex == 2)
                {
                    for (int cell = 3; cell < e.Row.Cells.Count - 1; cell++)
                    {
                        DropDownList ddlmodeall = new DropDownList();
                        ddlmodeall.Width = 80;
                        ddlmodeall.BackColor = Color.Gold;
                        ddlmodeall.AutoPostBack = true;
                        ddlmodeall.ID = "ddlmodeall_" + (cell - 2);
                        e.Row.Cells[cell].Controls.Add(ddlmodeall);

                        ((DropDownList)e.Row.FindControl("ddlmodeall_" + (cell - 2))).Attributes.Add("onchange",
                            "javascript:SelectAll('" +
                            ((DropDownList)e.Row.FindControl("ddlmodeall_" + (cell - 2))).ClientID + "')");
                        //ddlmodeall.SelectedIndexChanged += new EventHandler(ddlMode_Indexchanged);

                        e.Row.Cells[1].BackColor = Color.Gray;// ColorTranslator.FromHtml("#708090");
                        e.Row.Cells[2].BackColor = Color.Gray;// ColorTranslator.FromHtml("#708090");
                        e.Row.Cells[e.Row.Cells.Count - 1].BackColor = Color.Gray;// ColorTranslator.FromHtml("#708090");
                    }
                }
                else
                {
                    for (int cell = 3; cell < e.Row.Cells.Count - 1; cell++)
                    {
                        ...
                        ddlmode.Width = 80;
                        ddlmode.Attributes.Add("style", "background-color:#9dbc8f;");
                        ddlmode.ID = "ddlmode_" + (cell - 2);
                        ...
                        if (e.Row.Cells[e.Row.Cells.Count - 1].Text == "FP")
                        {
                            e.Row.Cells[e.Row.Cells.Count - 1].ForeColor = ColorTranslator.FromHtml("#008000");
                            e.Row.Cells[e.Row.Cells.Count - 1].BorderColor = Color.Black;
                        }
                        else if (e.Row.Cells[e.Row.Cells.Count - 1].Text == "HA")
                        {
                            e.Row.Cells[e.Row.Cells.Count - 1].ForeColor = ColorTranslator.FromHtml("#D2691E");
                            e.Row.Cells[e.Row.Cells.Count - 1].BorderColor = Color.Black;
                        }
                        else if (e.Row.Cells[e.Row.Cells.Count - 1].Text == "FA")
                        {
                            e.Row.Cells[e.Row.Cells.Count - 1].ForeColor = ColorTranslator.FromHtml("#FF0000");
                            e.Row.Cells[e.Row.Cells.Count - 1].BorderColor = Color.Black;
                        }
                        else if (e.Row.Cells[e.Row.Cells.Count - 1].Text == "HP")
                        {
                            e.Row.Cells[e.Row.Cells.Count - 1].ForeColor = ColorTranslator.FromHtml("#FFC0CB");
                            e.Row.Cells[e.Row.Cells.Count - 1].BorderColor = Color.Black;
                        }
                        else if (e.Row.Cells[e.Row.Cells.Count - 1].Text == "HD")
                        {
                    ...
                    #region HIDE
                    //for (int cel = 1; cel < attntable.Columns.Count - 1; cel++)
                    //{
                    //    string atten = attntable.Rows[(e.Row.RowIndex) - 3][1].ToString();
                    //    (gview.Rows[(e.Row.RowIndex)].FindControl("ddlmode_" + cel) as DropDownList).SelectedIndex = (gview.Rows[(e.Row.RowIndex)].FindControl("ddlmode_" + cel) as DropDownList).Items.IndexOf((gview.Rows[(e.Row.RowIndex)].FindControl("ddlmode_" + cel) as DropDownList).Items.FindByValue(atten));

                    //    DropDownList ddlmode = (gview.Rows[(e.Row.RowIndex) - 3].FindControl("ddlmode_" + cel) as DropDownList);
                    //    if (atten == "P")
                    //    {
                    //        ddlmode.ForeColor = ColorTranslator.FromHtml("#008000");
                    //    }
    ...
    //    if (uid != null && uid.Contains("ddlmodeall_"))
    //    {
    //        string[] values = uid.Split('$');
    //        //string row = values[3].Replace("ctl", "");
    //        string col = values[4].Replace("ddlmodeall_", "");
    //        Control ctrl = Page.FindControl(uid);
    //        DropDownList ddl = (DropDownList)ctrl;
    //        string attendance = ddl.SelectedValue;
    //        if (attendance != "Select for All")
    //            for (int rows = 3; rows < gview.Rows.Count; rows++)
    //            {
    //                (gview.Rows[rows].FindControl("ddlmode_" + col) as DropDownList).SelectedIndex = (gview.Rows[rows].FindControl("ddlmode_" + col) as DropDownList).Items.IndexOf((gview.Rows[rows].FindControl("ddlmode_" + col) as DropDownList).Items.FindByValue(attendance));
    //            }
    //    }
    //}
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            for (int r = 3; r < gview.Rows.Count; r++)
            {
                //string date = attnd_report.Sheets[0].Cells[r, 0].Text.ToString();
                string date = gview.Rows[r].Cells[2].Text;
                appNo = string.Empty;
                byte isStatus = 0;
                ...
                if (!string.IsNullOrEmpty(date) && !string.IsNullOrEmpty(appNo) && date.Trim() != "" && appNo != "0")
                {
                    ...
                    for (int c = 1; c < gview.HeaderRow.Cells.Count - 3; c++)
                    {
                        DropDownList ddl = (gview.Rows[r].FindControl("ddlmode_" + c) as DropDownList);
                        leave_flag = ddl.SelectedItem.Text;
    ...
    {
        double totalRows = 0;
        totalRows = Convert.ToInt32(gview.Rows.Count); //Convert.ToInt32(attnd_report.Sheets[0].RowCount);
        Session["totalPages"] = (int)Math.Ceiling(totalRows / gview.PageSize); //(int)Math.Ceiling(totalRows / attnd_report.Sheets[0].PageSize);
    ...
    protected void DropDownListpage_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            gview.Height = 30 + (24 * Convert.ToInt32(DropDownListpage.Text.ToString()));
    ...
    public void binddate()
    {
        ...
        if (isredoold == "1")
        {
            if (isredo1.ToLower() == "true" || isredo1 == "1" || delflag == "1" || delflag.ToLower() == "true")
            {
                ...
                str_query = "select  s.start_date ,s.end_date from seminfo s,registration a where s.degree_code='" + Convert.ToString(ds.Tables[0].Rows[0]["regdegree"]).Trim() + "' and s.batch_year='" + batch_year + "' and s.degree_code=a.degree_code  and a.app_no='" + appNo + "' and semester='" + sem + "'";
            }
            else
            {
    ...
    protected void viewattendall_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            if (viewattendall.Checked == true)
            {
                ...
                gview.Rows[0].Visible = true;
            }
            else
            {
                //attnd_report.Sheets[0].Rows[0].Visible = false;
                gview.Rows[0].Visible = false;
            }
        }
        catch (Exception ex)
        {
    ...
    protected void btnprintmaster1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (gview.Visible == true)
            {
                ...
                string ss = null;
                Printcontrol.loadspreaddetails(gview, pagename, dptname, 0, ss);
            }
    ...
    public static List<string> Getroll(string prefixText)
    {
        ...
        if (chosedmode == 0)
        {
            qury = " select distinct r.Roll_No from Registration r where  r.Roll_No like '" + prefixText + "%' order by Roll_No ";
        }
        else if (chosedmode == 1)
        {
            qury = " select distinct r.Reg_No from Registration r where r.Reg_No like '" + prefixText + "%' order by Reg_No";
        }
        else
        {
            qury = " select distinct r.Roll_Admit from Registration r where r.Roll_Admit like '" + prefixText + "%' order by Roll_Admit";
        }
        roll = ws.Getname(qury);
        return roll;
