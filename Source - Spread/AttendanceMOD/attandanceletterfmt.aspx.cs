...
public partial class attandance_letterfmt : System.Web.UI.Page
{
    ...
    protected void btntamilprint_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string trange = Convert.ToString(txttorange.Text);
            if (string.IsNullOrEmpty(trange))
            {
                divPopAlertContent.Visible = true;
                divPopAlert.Visible = true;
                lblAlertMsg.Visible = true;
                lblAlertMsg.Text = "Enter The Range";
                return;
            }
            ...
            for (res = 3; res < Convert.ToInt32(grdover.Rows.Count + 1); res++)
            {
                ...
                if (isval == 1)
                {
                    ...
                    if (grdover.Rows[res - 1].Visible == true)
                    {
                        ...
                        html.Append("<tr><td style='font-size: 12px; font-family: Times New Roman;  border: 0px solid black; text-align: left;'><span style='font-size: 12px;'> கடைசி வேலை நாள் <br> (உத்தேச  அட்டவணையின் படி) <br><br><span style='font-size: 12px;'>மேற்படி மாணவரின் வருகைப்பதிவு இப்பருவத்தின் கடைசி வேலை நாளன்று " + txttorange.Text.ToString() + "% விழுக்காடிற்கு குறைவாக இருக்குமேயானால்</span><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<span style='font-size: 26px; font-weight:bold;'>.</span><span style='font-size: 12px;'>&nbsp&nbsp&nbsp&nbsp மாணவா் பல்கலைக்கழகத்தேர்வு எழுத அனுமதிக்கப்படமாட்டார். </span><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<span style='font-size: 26px; font-weight:bold;'>.</span><span style='font-size: 12px;'>&nbsp&nbsp&nbsp&nbsp அரசின் கல்வி உதவித்தொகையும்  பெற முடியாது.</span><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<span style='font-size: 26px; font-weight:bold;'>.</span><span style='font-size: 12px;'>&nbsp&nbsp&nbsp&nbsp " + txttorange.Text.ToString() + "% க்கு குறைவான வருகைப்பதிவு உள்ளவர்கள் தங்கள் மகனுடன் இக்கடிதம் கண்டவுடன் </span><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span><span style='font-size: 12px;'>&nbsp&nbsp&nbsp&nbsp துறைத் தலைவர்/முதல்வரை நேரில் சந்திக்கவும். தொலைபேசியில் தொடர்பு கொள்வதை தவிர்க்கவும். </span>");
