...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:Panel ID="pBodyatendence" runat="server" CssClass="cpBody">
        ...
        <center>
        <div id="divGridII" runat="server" style="width: 900px; height: 900px; overflow: auto;">
         <asp:GridView ID="Showgrid" runat="server" Width="500px" BorderStyle="Double"
                            Font-Names="Book Antiqua" Font-Size="Medium" GridLines="Both" CellPadding="4"  
                             ShowFooter="false" ShowHeader="true" OnRowDataBound="OnRowDataBound" CssClass="HeaderFreez" >
