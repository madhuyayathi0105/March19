...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function SelectDropDown() {
            ...
            //alert(subid);
            var grid = document.getElementById('<%=GridView1.ClientID%>');
            var selall = document.getElementById('MainContent_GridView1_ddlSelectAll');
            var selall2 = document.getElementById('MainContent_GridView1_ddlSelectAll2');
            var selall3 = document.getElementById('MainContent_GridView1_ddlSelectAll3');
            var selall4 = document.getElementById('MainContent_GridView1_ddlSelectAll4');
            var selall5 = document.getElementById('MainContent_GridView1_ddlSelectAll5');
            var selall6 = document.getElementById('MainContent_GridView1_ddlSelectAll6');
            var selall7 = document.getElementById('MainContent_GridView1_ddlSelectAll7');
            var selall8 = document.getElementById('MainContent_GridView1_ddlSelectAll8');
            var selall9 = document.getElementById('MainContent_GridView1_ddlSelectAll9');
            var selall10 = document.getElementById('MainContent_GridView1_ddlSelectAll10');
            if (selall != null) {
                for (value = 0; value <= selall.options.length - 1; value++) {
                    if (selall.options[value].text.trim() == subsel.trim()) {
                        selall.options[value].selected = true;
                    }
                }
            }
            if (selall2 != null) {
                for (value = 0; value <= selall2.options.length - 1; value++) {
                    if (selall2.options[value].text.trim() == subsel.trim()) {
                        selall2.options[value].selected = true;
                    }
                }
            }
            if (selall3 != null) {
                for (value = 0; value <= selall3.options.length - 1; value++) {
                    if (selall3.options[value].text.trim() == subsel.trim()) {
                        selall3.options[value].selected = true;
                    }
                }
            }
            if (selall4 != null) {
                for (value = 0; value <= selall4.options.length - 1; value++) {
                    if (selall4.options[value].text.trim() == subsel.trim()) {
                        selall4.options[value].selected = true;
                    }
                }
            }
            if (selall5 != null) {
                for (value = 0; value <= selall5.options.length - 1; value++) {
                    if (selall5.options[value].text.trim() == subsel.trim()) {
                        selall5.options[value].selected = true;
                    }
                }
            }
            if (selall6 != null) {
                for (value = 0; value <= selall6.options.length - 1; value++) {
                    if (selall6.options[value].text.trim() == subsel.trim()) {
                        selall6.options[value].selected = true;
                    }
                }
            }
            if (selall7 != null) {
                for (value = 0; value <= selall7.options.length - 1; value++) {
                    if (selall7.options[value].text.trim() == subsel.trim()) {
                        selall7.options[value].selected = true;
                    }
                }
            }
            if (selall8 != null) {
                for (value = 0; value <= selall8.options.length - 1; value++) {
                    if (selall8.options[value].text.trim() == subsel.trim()) {
                        selall8.options[value].selected = true;
                    }
                }
            }
            if (selall9 != null) {
                for (value = 0; value <= selall9.options.length - 1; value++) {
                    if (selall9.options[value].text.trim() == subsel.trim()) {
                        selall9.options[value].selected = true;
                    }
                }
            }
            if (selall10 != null) {
                for (value = 0; value <= selall10.options.length - 1; value++) {
                    if (selall10.options[value].text.trim() == subsel.trim()) {
                        selall10.options[value].selected = true;
                    }
                }
            }
            ...
            for (var i = 0; i < grid.rows.length - 1; i++) {
                var selCall = document.getElementById('MainContent_GridView1_ddlSelect_' + i.toString());
                ...
                if (selCall != null) {
                    for (value = 0; value <= selCall.options.length - 1; value++) {
                        if (selCall.options[value].text.trim() == subsel.trim()) {
                            selCall.options[value].selected = true;
                        }
                    }
                }
        ...
        function DeSelectDropDown() {
            ...
            if (selall != null) {
                for (value = 0; value <= selall.options.length - 1; value++) {
                    if (selall.options[value].text.trim() == subid1.trim()) {
                        selall.options[value].selected = true;
                    }
                }
            }
            if (selall2 != null) {
                for (value = 0; value <= selall2.options.length - 1; value++) {
                    if (selall2.options[value].text.trim() == subid1.trim()) {
                        selall2.options[value].selected = true;
                    }
                }
            }
            if (selall3 != null) {
                for (value = 0; value <= selall3.options.length - 1; value++) {
                    if (selall3.options[value].text.trim() == subid1.trim()) {
                        selall3.options[value].selected = true;
                    }
                }
            }
            if (selall4 != null) {
                for (value = 0; value <= selall4.options.length - 1; value++) {
                    if (selall4.options[value].text.trim() == subid1.trim()) {
                        selall4.options[value].selected = true;
                    }
                }
            }
            if (selall5 != null) {
                for (value = 0; value <= selall5.options.length - 1; value++) {
                    if (selall5.options[value].text.trim() == subid1.trim()) {
                        selall5.options[value].selected = true;
                    }
                }
            }
            if (selall6 != null) {
                for (value = 0; value <= selall6.options.length - 1; value++) {
                    if (selall6.options[value].text.trim() == subid1.trim()) {
                        selall6.options[value].selected = true;
                    }
                }
            }
            if (selall7 != null) {
                for (value = 0; value <= selall7.options.length - 1; value++) {
                    if (selall7.options[value].text.trim() == subid1.trim()) {
                        selall7.options[value].selected = true;
                    }
                }
            }
            if (selall8 != null) {
                for (value = 0; value <= selall8.options.length - 1; value++) {
                    if (selall8.options[value].text.trim() == subid1.trim()) {
                        selall8.options[value].selected = true;
                    }
                }
            }
            if (selall9 != null) {
                for (value = 0; value <= selall9.options.length - 1; value++) {
                    if (selall9.options[value].text.trim() == subid1.trim()) {
                        selall9.options[value].selected = true;
                    }
                }
            }
            if (selall10 != null) {
                for (value = 0; value <= selall10.options.length - 1; value++) {
                    if (selall10.options[value].text.trim() == subid1.trim()) {
                        selall10.options[value].selected = true;
                    }
                }
            }
            ...
            for (var i = 0; i < grid.rows.length - 1; i++) {
                ...
                if (selCall != null) {
                    for (value = 0; value <= selCall.options.length - 1; value++) {
                        if (selCall.options[value].text.trim() == subid1.trim()) {
                            selCall.options[value].selected = true;
                        }
                    }
                }
