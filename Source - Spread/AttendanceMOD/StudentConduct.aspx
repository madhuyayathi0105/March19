                    ...
                    <center>
                                ...
                                <tr>
                                    <td align="left">
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:CheckBox ID="chkdate" runat="server" AutoPostBack="true" OnCheckedChanged="chkdate_OnCheckedChanged" />
                                                </td>
                                                <td>
                        ...
                        <div id="divMainContents" runat="server" style="display: table; margin: 0px; height: auto;
                            ...
                            <asp:GridView ID="gridview1" runat="server" ShowFooter="false" ShowHeader="false"
                                Font-Names="book antiqua" Width="887px" OnSelectedIndexChanged="gridview1_onselectedindexchanged"
                                OnRowDataBound="grdRowDataBound" OnRowCreated="grd1_OnRowCreated">
                            ...
                            <table style="text-align: left; margin-top: 15px; margin-bottom: 10px; position: relative;">
                                ...
                                <tr>
                                    <td align="left" colspan="10">
                                        <div id="divgrid2" style="width: 690px; height: 353px; overflow: auto;">
                                            ...
                                            <asp:GridView ID="gridview2" runat="server" ShowFooter="false" AutoGenerateColumns="true"
                                                ...
                                                ShowHeader="true" OnRowCreated="OnRowCreated" Width="670px" OnSelectedIndexChanged="gridview2_onselectedindexchanged"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:CheckBox ID="allchk" runat="server" AutoPostBack="true" OnCheckedChanged="allchk_OnCheckedChanged"
                                                                Text="Select All" /><%--OnClick="txtroll" onchange="return SelLedgers();"--%>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:CheckBox ID="selectchk" runat="server" AutoPostBack="true" OnCheckedChanged="selectchk_OnCheckedChanged" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <HeaderStyle BackColor="#0ca6ca" ForeColor="black" />
                    ...
                    <asp:Panel ID="panel3" runat="server" BorderColor="Black" BackColor="AliceBlue" Visible="false"
                        ...
                        <div class="PopupHeaderrstud2" id="Div1" style="text-align: center; font-family: MS Sans Serif;
                            ...
                            <table>
                                <tr>
                                    <td align="justify">
                                        <div id="divgrid3" style="width: 670px; height: 353px; overflow: auto;">
                                            <asp:HiddenField ID="HiddenField1" runat="server" Value="-1" />
                                            <asp:GridView ID="gridview3" runat="server" Width="483" ShowFooter="false" AutoGenerateColumns="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Select">
                                                        <ItemTemplate>
                                                            <asp:CheckBox ID="chkenbl" runat="server" AutoPostBack="true" OnCheckedChanged="chkenbl_OnCheckedChanged" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <HeaderStyle BackColor="#0ca6ca" ForeColor="black" />
                                ...
                                <tr>
                                    <td align="right">
                                        <fieldset style="width: 75px; height: auto; position: absolute; top: 520px; left: 480px;">
