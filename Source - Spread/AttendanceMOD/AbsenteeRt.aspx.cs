...
public partial class ReportClassLog : System.Web.UI.Page
{
    ...
    public void cal_date(double cumd,int affy)
    {
        ...
        int calm8 = affy * 12 + 8;
        int calm9 = affy * 12 + 9;
        int calm10 = affy * 12 + 10;
        int calm11 = affy * 12 + 11;
        int calm12 = affy * 12 + 12;
    ...
    public void findday()
    {
        ...
        nextmonth:
            totpresentday = 0;
            string[] afg = Convert.ToString(date_today).Split('/');
            string[] fyyd = afg[2].Split();

            int dffy = Convert.ToInt32(fyyd[0]);
            if (count == 0)
            {
                if (cumd == tcal)
                {
                        ...
                        int count1 = ds1.Tables[0].Rows.Count;
                        {
                            if (count1 > 0)
                            {
                                ...
                                //  if(Convert.ToInt16( ds1.Tables[0].Rows[i]["month_year"].ToString())==cumd)
                                {
                                    ...
                                    {
                                        //i++;
                                        if (((split_holiday_status_1 == "1" && Ihof >= 1) || (split_holiday_status_2 == "1" && IIhof <= 1 && Ihof < 1)) && 1 <= no_of_hrs)
                                        {
                                        ...
                                        if (((split_holiday_status_1 == "1" && Ihof >= 2) || (split_holiday_status_2 == "1" && IIhof <= 2 && Ihof < 2)) && 2 <= no_of_hrs)
                                        {
                                        ...
                                        if (((split_holiday_status_1 == "1" && Ihof >= 3) || (split_holiday_status_2 == "1" && IIhof <= 3 && Ihof < 3)) && 3 <= no_of_hrs)
                                        {
                                        ...
                                        if (((split_holiday_status_1 == "1" && Ihof >= 4) || (split_holiday_status_2 == "1" && IIhof <= 4 && Ihof < 4)) && 4 <= no_of_hrs)
                                        {
                                        ...
                                        if (((split_holiday_status_1 == "1" && Ihof >= 5) || (split_holiday_status_2 == "1" && IIhof <= 5 && Ihof < 5)) && 5 <= no_of_hrs)
                                        {
                                        ...
                                        if (((split_holiday_status_1 == "1" && Ihof >= 6) || (split_holiday_status_2 == "1" && IIhof <= 6 && Ihof < 6)) && 6 <= no_of_hrs)
                                        {
                                        ...
                                        if (((split_holiday_status_1 == "1" && Ihof <= 7) || (split_holiday_status_2 == "1" && IIhof <= 7 && Ihof < 7)) && 7 <= no_of_hrs)
                                        {
                                        ...
                                        if (((split_holiday_status_1 == "1" && Ihof >= 8) || (split_holiday_status_2 == "1" && IIhof <= 8 && Ihof < 8)) && 8 <= no_of_hrs)
                                        {
                                        ...
                                        if (((split_holiday_status_1 == "1" && Ihof >= 9) || (split_holiday_status_2 == "1" && IIhof <= 9 && Ihof < 9)) && 9 <= no_of_hrs)
                                        {
                                    ...
                                    if (ddlreport.Items[i].Selected == true)
                                    {
                                        ...
                                        if (!string.IsNullOrEmpty(criteria))
                                        {
                                            ...
                                            critirianame = new System.Text.StringBuilder(criteria);
                                               string colnamval = curday.ToString("d-MM-yyyy") + "/" + critirianame;
                                               dtcout.Columns.Add(colnamval);
                                          //  AddTableColumn(dtable4, critirianame);
                                                    ...
                                                    for (int y = 1; y <= Convert.ToInt32(sqlsquery); y++)
                                                    {
                                                        ...
                                                        if (rdiobtndetailornot.Text == "Count")
                                                        {
                                                            ...
                                                            if (strdayhour != "" && strdayhour != "0")
                                                            {
                                                                ...
                                                                {
                                                                    datrow = curday.ToString("d-MM-yyyy") + "/" + coln;
                                                                    dr1[datrow] = count;
                                                                }
