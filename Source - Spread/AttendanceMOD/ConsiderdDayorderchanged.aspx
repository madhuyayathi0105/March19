                        ...
                        <asp:AccordionPane ID="AccordionPane1" runat="server" Style="padding: 20px; margin: 20px;
                            ...
                            <Content>
                                <div style="width: auto; height: auto;">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                                        <ContentTemplate>
                                                            <div style="position: relative;">
                                                                <asp:DropDownList ID="ddlCollege" AutoPostBack="true" runat="server" Font-Bold="True"
                                                                    Font-Names="Book Antiqua" Font-Size="Medium" Width="182px" OnSelectedIndexChanged="ddlCollege_SelectedIndexChanged">
                                                                </asp:DropDownList>
                                                            </div>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                    ...
                                    <center>
                                        <div runat="server" id="gviewdiv" style="height: 300px; overflow: auto;">
                                            <asp:HiddenField ID="SelectedGridCellIndex" runat="server" Value="-1" />
                                            <asp:GridView runat="server" ID="gview" Height="300" AutoGenerateColumns="true" ShowHeader="false"
                                                OnRowCreated="gviewOnRowCreated" ShowFooter="false" OnSelectedIndexChanged="gview_OnSelectedIndexChanged"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Tag" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbltagdeg" Visible="false" runat="server" Text='<%#Eval("tagdegree") %>' />
                                                            <asp:Label ID="lbltagdep" Visible="false" runat="server" Text='<%#Eval("tagdepartment") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                        ...
                                        <div>
                                            <table style="margin: 0px; margin-top: 10px; margin-bottom: 10px; position: relative;
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-right: 15px; padding-left: 5px;">
                                                        <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                                                            <ContentTemplate>
                                                                <div style="position: relative;">
                                                                    <asp:DropDownList ID="ddlcoll" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                                                                        AutoPostBack="true" Font-Size="Medium" Width="182px" OnSelectedIndexChanged="ddlcoll_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </div>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <asp:CheckBox ID="Chkasperday" Text="As Perday Schedule" Checked="false" Visible="false"
                                                            runat="server" AutoPostBack="true" Style="font-weight: bold;" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="5" style="padding-left: 15px; margin: 0px; margin-top: 10px; margin-bottom: 10px;
                                                        ...
                                                        <fieldset style="width: 504px; height: 48px;">
                                                            ...
                                                            <asp:RadioButton ID="rdbasperday" runat="server" Text="As Perday Schedule" GroupName="orderchange"
                                                                AutoPostBack="true" />
